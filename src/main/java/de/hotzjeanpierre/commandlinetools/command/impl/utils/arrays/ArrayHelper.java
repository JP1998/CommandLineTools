...
package de.hotzjeanpierre.commandlinetools.command.impl.utils.arrays;
...
public class ArrayHelper {
     ...
     * @param element The element to check whether it is in the given array.
     * @param <T> An arbitrary type that the array is declared with.
     * @return Whether the given element is contained within the array-
     */
